"""
Django settings for stepfreemta project.
...
TEMPLATES = [
    {
        ...
        "DIRS": [],
        "APP_DIRS": True,  # Enable to search for templates inside app directories
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "stepfreemta.wsgi.application"
